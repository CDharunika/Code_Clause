...
coverMainFrame = Frame (coverFrame, bd=10, pady=2, bg='green' , relief = RIDGE)
coverMainFrame.grid()
...
entDisplay = Entry(MainFrame, font=('arial',18,'bold'), bd=14 ,width=26, bg='green', justify=RIGHT)
